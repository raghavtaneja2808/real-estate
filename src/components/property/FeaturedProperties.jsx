            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
                    <div className="max-w-xl mb-6 md:mb-0">
                        ...
                        <h2 className="text-4xl font-bold mb-4">Explore Endless Possibilites</h2>
                        <p className="text-gray-400">
                            A secure way to save your money through crypto , don't fall behind this increase your wealth through Blockchain
                        </p>
                    </div>
                    <Link to="/search" className="px-5 py-2 border border-gray-600 text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors whitespace-nowrap">
                        View All Properties
                    </Link>
                </div>
